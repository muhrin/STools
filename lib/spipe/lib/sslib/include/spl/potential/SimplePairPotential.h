...
public:
  ...
  // From IPotential /////////////
  virtual ::boost::optional<double> getPotentialRadius(const ::spl::common::AtomSpeciesId::Value id) const;
  virtual ::boost::shared_ptr< IPotentialEvaluator > createEvaluator(const spl::common::Structure & structure) const;
