...
template< class ScalarSchema, class ListSchema, class MapSchema>
  class SchemaScalarListMap : public detail::SchemaElementBase<
      ::boost::variant< typename ScalarSchema::BindingType,
          typename ListSchema::BindingType, typename MapSchema::BindingType> >
  {
  public:
    typedef ::boost::variant< typename ScalarSchema::BindingType,
        typename ListSchema::BindingType, typename MapSchema::BindingType> BindingType;

    SchemaScalarListMap(const ScalarSchema & scalarSchema,
        const ListSchema & listSchema, const MapSchema & mapSchema);
    ...
    virtual bool
    valueToNode(YAML::Node & node, const BindingType & binding,
        const bool useDefaultOnFail) const;
    virtual bool
    nodeToValue(SchemaParse & parse, BindingType & binding,
...
template< class ListSchema, class MapSchema>
  class SchemaListMap : public detail::SchemaElementBase<
      ::boost::variant< typename ListSchema::BindingType,
          typename MapSchema::BindingType> >
  {
  public:
    typedef ::boost::variant< typename ListSchema::BindingType,
        typename MapSchema::BindingType> BindingType;

    SchemaListMap();
    SchemaListMap(const ListSchema & listSchema, const MapSchema & mapSchema);
