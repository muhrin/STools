 ...
 if (_LANGUAGES_ MATCHES C OR _LANGUAGES_ MATCHES CXX)
  ...
  if(BLA_F95)
    ...
    if (WIN32)
	  ...
	  if(BLA_STATIC)
	    list(APPEND BLAS_SEARCH_LIBS
          "mkl_blas95 mkl_intel_c mkl_intel_thread mkl_core libiomp5md")
	  else ()
	    list(APPEND BLAS_SEARCH_LIBS
          "mkl_blas95 mkl_intel_c_dll mkl_intel_thread_dll mkl_core_dll libiomp5md")
	  endif ()
    else ()
    ...
    if (WIN32)
	  ...
	  if(BLA_STATIC)
	    ...
	    list(APPEND BLAS_SEARCH_LIBS
          "mkl_intel_c_dll mkl_intel_thread_dll mkl_core_dll libiomp5md")
	  endif ()
    else ()
      if (BLA_VENDOR STREQUAL "Intel10_32" OR BLA_VENDOR STREQUAL "All")
        list(APPEND BLAS_SEARCH_LIBS
